...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(
				auth -> auth
				.requestMatchers("/auth/**","/images/**","/images","/image/images/**","/User/signup","/User/resetPassword","/User/resendOtp","/User/forgotPassword","User/verify", "/inventoryManagement/**","/v3/api-docs/**","/swagger-ui.html","/swagger-ui/**")
				.permitAll()
				.anyRequest()
